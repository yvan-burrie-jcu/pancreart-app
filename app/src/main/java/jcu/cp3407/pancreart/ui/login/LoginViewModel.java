...
import jcu.cp3407.pancreart.data.Result;
...
public class LoginViewModel extends ViewModel {
    ...
    public void login(String username, String password, String address) {
        ...
        Result<LoggedInUser> result = loginRepository.login(username, password, address);
    ...
    private boolean isPasswordValid(String password) {
        return password != null && password.trim().length() > 5; // todo: password length
    }
}
